...
public class ProductService {
	...
	//find product by name or keyword
	public List<Product> findByNameOrKeyword(String name, String keyword){
		List<Product> products = this.productRepo.findByNameContainingIgnoreCaseOrSaltContainingIgnoreCase(name, keyword);
		return products;
	}
